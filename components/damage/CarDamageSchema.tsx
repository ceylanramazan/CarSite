...
export default function CarDamageSchema({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative mx-auto max-w-3xl bg-gray-50 rounded-2xl p-4 sm:p-6 md:p-8">
        <svg
          version="1.1"
        ...
        >
          <style>{`
            ...
            .car-part:hover {
              stroke: #0ea5e9;
              stroke-width: 2;
              filter: brightness(1.05) drop-shadow(0 0 8px rgba(14, 165, 233, 0.5));
            }
          `}</style>
          ...
          <path 
            ...
            c-0.25-2.4-0.45-4.33-0.7-6.8C515.35,133.3,507.03,135.54,498.58,137.09z"
          />
