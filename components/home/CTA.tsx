    ...
    <section className="relative py-8 sm:py-10 md:py-12 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="mt-3 sm:mt-4 text-base sm:text-lg text-gray-800 px-4">
          ...
          <div className="mt-6 sm:mt-8 flex justify-center">
            <Link href="/teklif-al/arac-bilgileri" className="w-full sm:w-auto">
              <Button
                variant="outline"
                className="w-full sm:w-auto px-6 sm:px-8 py-3 text-base font-semibold border-gray-800 bg-gray-800 text-white hover:bg-gray-700"
              >
                Ücretsiz Teklif Al
